...
const HIGHLIGHTS = [
  { value: '$12B+', label: 'Global ATO Fraud Losses' },
  { value: '85%', label: 'Identity Fraud is Synthetic' },
  { value: '64%', label: 'MFA Transaction Abandonment' },
  { value: '<200ms', label: 'Required Threat Response Time' },
];
